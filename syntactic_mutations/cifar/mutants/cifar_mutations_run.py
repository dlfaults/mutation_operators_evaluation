...
def get_dataset(i):
    dataset_file = "/home/ubuntu/dataset/cifar_dataset/cifar_crossval_set_" + str(i) + ".h5"
...
csv_name = "cifar_syntacticmutations_results.csv"    
with open(csv_name, 'w') as f1:
    ...
    try:
        ...
        for i in range(0, num):
                ...
                model_name = "cifar1_mutation1_1_" + str(i) + ".h5"
                loss, acc =  mutant1.train_model(x_train, y_train, x_test, y_test, model_name)
                K.clear_session()
